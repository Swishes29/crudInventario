...
<div class="container">
    ...
    <a href="crear_proveedor.php" class="btn btn-outline-primary mb-3">
        ...
        <?php foreach ($proveedores as $proveedor): ?>
            <tr>
                ...
                <td class="text-center">
                    <a href="editar_proveedor.php?id=<?= $proveedor['ID_Proveedor'] ?>" class="btn btn-outline-warning btn-sm">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="eliminar_proveedor.php?id=<?= $proveedor['ID_Proveedor'] ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este proveedor?')">
